    ...
    public class SigSpecToTypeScriptGenerator
    {
        ...
        public IEnumerable<CodeArtifact> GenerateArtifacts(SigSpecDocument document)
        {
            ...
            foreach (var hub in document.Hubs)
            {
                ...
                artifacts.Add(new CodeArtifact(hubModel.Name, CodeArtifactType.Class, CodeArtifactLanguage.TypeScript, CodeArtifactCategory.Utility, template));
            }
            ...
            if (_settings.GenerateDtoTypes)
            {
                ...
                return new List<CodeArtifact>(artifacts.Concat(types));
            }
            else
            {
                ...
                return new List<CodeArtifact>(artifacts);
            }
        }
